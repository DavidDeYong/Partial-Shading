...
static void initialize_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initialize_params_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void enable_c21_ArregloSeisPorSeis(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void disable_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void set_sim_state_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance, const mxArray *c21_st);
static void finalize_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void sf_c21_ArregloSeisPorSeis(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void c21_chartstep_c21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initSimStructsc21_ArregloSeisPorSeis
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c21_I, const char_T *c21_identifier);
static real_T c21_b_emlrt_marshallIn(SFc21_ArregloSeisPorSeisInstanceStruct
...
static const mxArray *c21_b_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_c_emlrt_marshallIn(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_d_emlrt_marshallIn(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_ArregloSeisPorSeis, const
  char_T *c21_identifier);
static uint8_T c21_e_emlrt_marshallIn(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
  ...
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_ArregloSeisPorSeis = 0U;
}
  ...
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_ArregloSeisPorSeis;
  ...
  (SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance, const mxArray *c21_st)
{
  ...
  *c21_I = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u,
    0)), "I");
  chartInstance->c21_is_active_c21_ArregloSeisPorSeis = c21_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_ArregloSeisPorSeis");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_ArregloSeisPorSeis(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_ArregloSeisPorSeis(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc21_ArregloSeisPorSeisInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_ArregloSeisPorSeis_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_ArregloSeisPorSeis), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_ArregloSeisPorSeis);
  return c21_y;
}
...
/* SFunction Glue Code */
void sf_c21_ArregloSeisPorSeis_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_ArregloSeisPorSeis_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_ArregloSeisPorSeis(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c21_ArregloSeisPorSeis\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_ArregloSeisPorSeis_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance;
    chartInstance = (SFc21_ArregloSeisPorSeisInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c21_ArregloSeisPorSeis(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_ArregloSeisPorSeis
    ((SFc21_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar);
  initialize_c21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c21_ArregloSeisPorSeis(void *chartInstanceVar)
{
  enable_c21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c21_ArregloSeisPorSeis(void *chartInstanceVar)
{
  disable_c21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c21_ArregloSeisPorSeis(void *chartInstanceVar)
{
  sf_c21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_ArregloSeisPorSeis(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_ArregloSeisPorSeis
    ((SFc21_ArregloSeisPorSeisInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_ArregloSeisPorSeis();/* state var info */
...
extern void sf_internal_set_sim_state_c21_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_ArregloSeisPorSeis(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c21_ArregloSeisPorSeis(S);
}

static void sf_opaque_set_sim_state_c21_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c21_ArregloSeisPorSeis(S, st);
}

static void sf_opaque_terminate_c21_ArregloSeisPorSeis(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc21_ArregloSeisPorSeis((SFc21_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_ArregloSeisPorSeis(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_ArregloSeisPorSeis
      ((SFc21_ArregloSeisPorSeisInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c21_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_ArregloSeisPorSeis(SimStruct *S)
{
  SFc21_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc21_ArregloSeisPorSeisInstanceStruct *)malloc(sizeof
    (SFc21_ArregloSeisPorSeisInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_ArregloSeisPorSeisInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_ArregloSeisPorSeis;
...
void c21_ArregloSeisPorSeis_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_ArregloSeisPorSeis(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_ArregloSeisPorSeis_method_dispatcher.\n"
