...
static void initialize_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initialize_params_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void enable_c33_ArregloSeisPorSeis(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void disable_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void c33_update_debugger_state_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void set_sim_state_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance, const mxArray *c33_st);
static void finalize_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void sf_c33_ArregloSeisPorSeis(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void c33_chartstep_c33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initSimStructsc33_ArregloSeisPorSeis
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance);
...
static const mxArray *c33_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static real_T c33_emlrt_marshallIn(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c33_I, const char_T *c33_identifier);
static real_T c33_b_emlrt_marshallIn(SFc33_ArregloSeisPorSeisInstanceStruct
...
static const mxArray *c33_b_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static int32_T c33_c_emlrt_marshallIn(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId);
static void c33_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c33_mxArrayInData, const char_T *c33_varName, void *c33_outData);
static uint8_T c33_d_emlrt_marshallIn(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c33_b_is_active_c33_ArregloSeisPorSeis, const
  char_T *c33_identifier);
static uint8_T c33_e_emlrt_marshallIn(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId);
static void init_dsm_address_info(SFc33_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
  ...
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  chartInstance->c33_is_active_c33_ArregloSeisPorSeis = 0U;
}
  ...
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  c33_b_hoistedGlobal = chartInstance->c33_is_active_c33_ArregloSeisPorSeis;
  ...
  (SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance, const mxArray *c33_st)
{
  ...
  *c33_I = c33_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c33_u,
    0)), "I");
  chartInstance->c33_is_active_c33_ArregloSeisPorSeis = c33_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c33_u, 1)),
     "is_active_c33_ArregloSeisPorSeis");
  sf_mex_destroy(&c33_u);
  c33_update_debugger_state_c33_ArregloSeisPorSeis(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c33_sfEvent = CALL_EVENT;
  c33_chartstep_c33_ArregloSeisPorSeis(chartInstance);
  ...
  *c33_inData)
{
  ...
  const mxArray *c33_y = NULL;
  SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc33_ArregloSeisPorSeisInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c33_ArregloSeisPorSeis_get_eml_resolved_functions_info(void)
{
  ...
  (*c33_b_info)[0].fileTimeLo = 1289534092U;
  ...
  (*c33_b_info)[1].fileTimeLo = 1325138538U;
  (*c33_b_info)[1].fileTimeHi = 0U;
  (*c33_b_info)[1].mFileTimeLo = 1319747966U;
  ...
  char_T *c33_identifier)
{
  ...
  c33_y = c33_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c33_b_is_active_c33_ArregloSeisPorSeis), &c33_thisId);
  sf_mex_destroy(&c33_b_is_active_c33_ArregloSeisPorSeis);
  return c33_y;
}
...
/* SFunction Glue Code */
void sf_c33_ArregloSeisPorSeis_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c33_ArregloSeisPorSeis_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c33_ArregloSeisPorSeis(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c33_ArregloSeisPorSeis\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c33_ArregloSeisPorSeis_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance;
    chartInstance = (SFc33_ArregloSeisPorSeisInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c33_ArregloSeisPorSeis(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c33_ArregloSeisPorSeis
    ((SFc33_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar);
  initialize_c33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c33_ArregloSeisPorSeis(void *chartInstanceVar)
{
  enable_c33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c33_ArregloSeisPorSeis(void *chartInstanceVar)
{
  disable_c33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c33_ArregloSeisPorSeis(void *chartInstanceVar)
{
  sf_c33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c33_ArregloSeisPorSeis(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c33_ArregloSeisPorSeis
    ((SFc33_ArregloSeisPorSeisInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c33_ArregloSeisPorSeis();/* state var info */
...
extern void sf_internal_set_sim_state_c33_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c33_ArregloSeisPorSeis(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c33_ArregloSeisPorSeis(S);
}

static void sf_opaque_set_sim_state_c33_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c33_ArregloSeisPorSeis(S, st);
}

static void sf_opaque_terminate_c33_ArregloSeisPorSeis(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc33_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc33_ArregloSeisPorSeis((SFc33_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c33_ArregloSeisPorSeis(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c33_ArregloSeisPorSeis
      ((SFc33_ArregloSeisPorSeisInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c33_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c33_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c33_ArregloSeisPorSeis(SimStruct *S)
{
  SFc33_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc33_ArregloSeisPorSeisInstanceStruct *)malloc(sizeof
    (SFc33_ArregloSeisPorSeisInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc33_ArregloSeisPorSeisInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlStart = mdlStart_c33_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c33_ArregloSeisPorSeis;
...
void c33_ArregloSeisPorSeis_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c33_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c33_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c33_ArregloSeisPorSeis(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c33_ArregloSeisPorSeis_method_dispatcher.\n"
