...
static void initialize_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initialize_params_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void enable_c23_ArregloSeisPorSeis(SFc23_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void disable_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void c23_update_debugger_state_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
...
static void finalize_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void sf_c23_ArregloSeisPorSeis(SFc23_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void c23_chartstep_c23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initSimStructsc23_ArregloSeisPorSeis
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance);
...
static real_T c23_b_emlrt_marshallIn(SFc23_ArregloSeisPorSeisInstanceStruct
...
static const mxArray *c23_b_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_c_emlrt_marshallIn(SFc23_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
...
static uint8_T c23_e_emlrt_marshallIn(SFc23_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void init_dsm_address_info(SFc23_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
  ...
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_ArregloSeisPorSeis = 0U;
}
  ...
  (SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  c23_b_hoistedGlobal = chartInstance->c23_is_active_c23_ArregloSeisPorSeis;
  ...
  *chartInstance)
{
  ...
  chartInstance->c23_sfEvent = CALL_EVENT;
  c23_chartstep_c23_ArregloSeisPorSeis(chartInstance);
...
const mxArray *sf_c23_ArregloSeisPorSeis_get_eml_resolved_functions_info(void)
{
  ...
  (*c23_b_info)[0].fileTimeLo = 1289534092U;
  ...
  (*c23_b_info)[1].fileTimeLo = 1325138538U;
  (*c23_b_info)[1].fileTimeHi = 0U;
  (*c23_b_info)[1].mFileTimeLo = 1319747966U;
...
/* SFunction Glue Code */
void sf_c23_ArregloSeisPorSeis_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c23_ArregloSeisPorSeis_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c23_ArregloSeisPorSeis(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c23_ArregloSeisPorSeis\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_ArregloSeisPorSeis_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c23_ArregloSeisPorSeis(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c23_ArregloSeisPorSeis
    ((SFc23_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar);
  initialize_c23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c23_ArregloSeisPorSeis(void *chartInstanceVar)
{
  enable_c23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c23_ArregloSeisPorSeis(void *chartInstanceVar)
{
  disable_c23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c23_ArregloSeisPorSeis(void *chartInstanceVar)
{
  sf_c23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c23_ArregloSeisPorSeis(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c23_ArregloSeisPorSeis
    ((SFc23_ArregloSeisPorSeisInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c23_ArregloSeisPorSeis();/* state var info */
...
extern void sf_internal_set_sim_state_c23_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c23_ArregloSeisPorSeis(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c23_ArregloSeisPorSeis(S);
}

static void sf_opaque_set_sim_state_c23_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c23_ArregloSeisPorSeis(S, st);
}

static void sf_opaque_terminate_c23_ArregloSeisPorSeis(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc23_ArregloSeisPorSeis((SFc23_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_ArregloSeisPorSeis(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c23_ArregloSeisPorSeis
      ((SFc23_ArregloSeisPorSeisInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c23_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c23_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_ArregloSeisPorSeis(SimStruct *S)
{
  SFc23_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc23_ArregloSeisPorSeisInstanceStruct *)malloc(sizeof
    (SFc23_ArregloSeisPorSeisInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_ArregloSeisPorSeisInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c23_ArregloSeisPorSeis;
...
void c23_ArregloSeisPorSeis_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_ArregloSeisPorSeis(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_ArregloSeisPorSeis_method_dispatcher.\n"
