...
static void initialize_c4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initialize_params_c4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void enable_c4_ArregloSeisPorSeis(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void disable_c4_ArregloSeisPorSeis(SFc4_ArregloSeisPorSeisInstanceStruct *
  chartInstance);
static void c4_update_debugger_state_c4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void set_sim_state_c4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_ArregloSeisPorSeis(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void sf_c4_ArregloSeisPorSeis(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
static void c4_chartstep_c4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void initSimStructsc4_ArregloSeisPorSeis
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c4_I, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_ArregloSeisPorSeis, const
  char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_ArregloSeisPorSeisInstanceStruct
  *chartInstance);
  ...
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_ArregloSeisPorSeis = 0U;
}
  ...
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_ArregloSeisPorSeis;
  ...
  (SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_I = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)),
    "I");
  chartInstance->c4_is_active_c4_ArregloSeisPorSeis = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_ArregloSeisPorSeis");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_ArregloSeisPorSeis(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_ArregloSeisPorSeis(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc4_ArregloSeisPorSeisInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_ArregloSeisPorSeis_get_eml_resolved_functions_info(void)
{
  ...
  (*c4_b_info)[0].fileTimeLo = 1289534092U;
  ...
  (*c4_b_info)[1].fileTimeLo = 1325138538U;
  (*c4_b_info)[1].fileTimeHi = 0U;
  (*c4_b_info)[1].mFileTimeLo = 1319747966U;
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_ArregloSeisPorSeis), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_ArregloSeisPorSeis);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_ArregloSeisPorSeis_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_ArregloSeisPorSeis_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_ArregloSeisPorSeis(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c4_ArregloSeisPorSeis\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_ArregloSeisPorSeis_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance;
    chartInstance = (SFc4_ArregloSeisPorSeisInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c4_ArregloSeisPorSeis(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
  initialize_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_ArregloSeisPorSeis(void *chartInstanceVar)
{
  enable_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_ArregloSeisPorSeis(void *chartInstanceVar)
{
  disable_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_ArregloSeisPorSeis(void *chartInstanceVar)
{
  sf_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_ArregloSeisPorSeis(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_ArregloSeisPorSeis
    ((SFc4_ArregloSeisPorSeisInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_ArregloSeisPorSeis();/* state var info */
...
extern void sf_internal_set_sim_state_c4_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_ArregloSeisPorSeis(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_ArregloSeisPorSeis(S);
}

static void sf_opaque_set_sim_state_c4_ArregloSeisPorSeis(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_ArregloSeisPorSeis(S, st);
}

static void sf_opaque_terminate_c4_ArregloSeisPorSeis(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_ArregloSeisPorSeisInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_ArregloSeisPorSeis((SFc4_ArregloSeisPorSeisInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_ArregloSeisPorSeis(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_ArregloSeisPorSeis
      ((SFc4_ArregloSeisPorSeisInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_ArregloSeisPorSeis(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_ArregloSeisPorSeis(SimStruct *S)
{
  SFc4_ArregloSeisPorSeisInstanceStruct *chartInstance;
  chartInstance = (SFc4_ArregloSeisPorSeisInstanceStruct *)malloc(sizeof
    (SFc4_ArregloSeisPorSeisInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_ArregloSeisPorSeisInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_ArregloSeisPorSeis;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_ArregloSeisPorSeis;
...
void c4_ArregloSeisPorSeis_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_ArregloSeisPorSeis(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_ArregloSeisPorSeis(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_ArregloSeisPorSeis_method_dispatcher.\n"
