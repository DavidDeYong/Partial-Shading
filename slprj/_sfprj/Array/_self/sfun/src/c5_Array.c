...
static void initialize_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void initialize_params_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void enable_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void disable_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Array(SFc5_ArrayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_Array(SFc5_ArrayInstanceStruct
  *chartInstance);
static void set_sim_state_c5_Array(SFc5_ArrayInstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void sf_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void c5_chartstep_c5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void initSimStructsc5_Array(SFc5_ArrayInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_ArrayInstanceStruct *chartInstance, const
  mxArray *c5_I, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_ArrayInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_ArrayInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_ArrayInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_Array, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_ArrayInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_ArrayInstanceStruct *chartInstance);
...
static void initialize_c5_Array(SFc5_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Array = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_Array;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_I = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)),
    "I");
  chartInstance->c5_is_active_c5_Array = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_Array");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_Array(chartInstance);
...
static void sf_c5_Array(SFc5_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_Array(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc5_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_Array_get_eml_resolved_functions_info(void)
{
  ...
  (*c5_b_info)[0].fileTimeLo = 1289530492U;
  ...
  (*c5_b_info)[1].fileTimeLo = 1325134938U;
  (*c5_b_info)[1].fileTimeHi = 0U;
  (*c5_b_info)[1].mFileTimeLo = 1319744366U;
  ...
  const mxArray *c5_b_is_active_c5_Array, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_Array),
    &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Array);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c5_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Array_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_ArrayInstanceStruct *chartInstance;
    chartInstance = (SFc5_ArrayInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_ArrayInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_Array(void *chartInstanceVar)
{
  enable_c5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_Array(void *chartInstanceVar)
{
  disable_c5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_Array(void *chartInstanceVar)
{
  sf_c5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_Array((SFc5_ArrayInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_Array();/* state var info */
...
extern void sf_internal_set_sim_state_c5_Array(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_Array((SFc5_ArrayInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_Array(S);
}

static void sf_opaque_set_sim_state_c5_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Array(S, st);
}

static void sf_opaque_terminate_c5_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_Array((SFc5_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_Array((SFc5_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Array(SimStruct *S)
{
  SFc5_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc5_ArrayInstanceStruct *)malloc(sizeof
    (SFc5_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Array;
...
void c5_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Array_method_dispatcher.\n"
