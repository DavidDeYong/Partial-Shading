...
static void initialize_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void initialize_params_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void enable_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void disable_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void c29_update_debugger_state_c29_Array(SFc29_ArrayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c29_Array(SFc29_ArrayInstanceStruct
  *chartInstance);
static void set_sim_state_c29_Array(SFc29_ArrayInstanceStruct *chartInstance,
  const mxArray *c29_st);
static void finalize_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void sf_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void c29_chartstep_c29_Array(SFc29_ArrayInstanceStruct *chartInstance);
static void initSimStructsc29_Array(SFc29_ArrayInstanceStruct *chartInstance);
...
static const mxArray *c29_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static real_T c29_emlrt_marshallIn(SFc29_ArrayInstanceStruct *chartInstance,
  const mxArray *c29_I, const char_T *c29_identifier);
static real_T c29_b_emlrt_marshallIn(SFc29_ArrayInstanceStruct *chartInstance,
...
static const mxArray *c29_b_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static int32_T c29_c_emlrt_marshallIn(SFc29_ArrayInstanceStruct *chartInstance,
  const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void c29_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData);
static uint8_T c29_d_emlrt_marshallIn(SFc29_ArrayInstanceStruct *chartInstance,
  const mxArray *c29_b_is_active_c29_Array, const char_T *c29_identifier);
static uint8_T c29_e_emlrt_marshallIn(SFc29_ArrayInstanceStruct *chartInstance,
  const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void init_dsm_address_info(SFc29_ArrayInstanceStruct *chartInstance);
...
static void initialize_c29_Array(SFc29_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c29_is_active_c29_Array = 0U;
}
  ...
  *chartInstance)
{
  ...
  c29_b_hoistedGlobal = chartInstance->c29_is_active_c29_Array;
  ...
  const mxArray *c29_st)
{
  ...
  *c29_I = c29_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c29_u,
    0)), "I");
  chartInstance->c29_is_active_c29_Array = c29_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c29_u, 1)), "is_active_c29_Array");
  sf_mex_destroy(&c29_u);
  c29_update_debugger_state_c29_Array(chartInstance);
...
static void sf_c29_Array(SFc29_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c29_sfEvent = CALL_EVENT;
  c29_chartstep_c29_Array(chartInstance);
  ...
  *c29_inData)
{
  ...
  real_T c29_u;
  const mxArray *c29_y = NULL;
  SFc29_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc29_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c29_Array_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c29_b_is_active_c29_Array, const char_T *c29_identifier)
{
  ...
  c29_y = c29_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c29_b_is_active_c29_Array), &c29_thisId);
  sf_mex_destroy(&c29_b_is_active_c29_Array);
  return c29_y;
}
...
/* SFunction Glue Code */
void sf_c29_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c29_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c29_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c29_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c29_Array_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc29_ArrayInstanceStruct *chartInstance;
    chartInstance = (SFc29_ArrayInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c29_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc29_ArrayInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c29_Array(void *chartInstanceVar)
{
  enable_c29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c29_Array(void *chartInstanceVar)
{
  disable_c29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c29_Array(void *chartInstanceVar)
{
  sf_c29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c29_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c29_Array((SFc29_ArrayInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c29_Array();/* state var info */
...
extern void sf_internal_set_sim_state_c29_Array(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c29_Array((SFc29_ArrayInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c29_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c29_Array(S);
}

static void sf_opaque_set_sim_state_c29_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c29_Array(S, st);
}

static void sf_opaque_terminate_c29_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc29_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc29_Array((SFc29_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c29_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c29_Array((SFc29_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c29_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c29_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c29_Array(SimStruct *S)
{
  SFc29_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc29_ArrayInstanceStruct *)malloc(sizeof
    (SFc29_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc29_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c29_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c29_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c29_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c29_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c29_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c29_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c29_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c29_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c29_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c29_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c29_Array;
...
void c29_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c29_Array(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c29_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c29_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c29_Array_method_dispatcher.\n"
