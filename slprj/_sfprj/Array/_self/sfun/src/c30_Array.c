...
static void initialize_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void initialize_params_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void enable_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void disable_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void c30_update_debugger_state_c30_Array(SFc30_ArrayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c30_Array(SFc30_ArrayInstanceStruct
  *chartInstance);
static void set_sim_state_c30_Array(SFc30_ArrayInstanceStruct *chartInstance,
  const mxArray *c30_st);
static void finalize_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void sf_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void c30_chartstep_c30_Array(SFc30_ArrayInstanceStruct *chartInstance);
static void initSimStructsc30_Array(SFc30_ArrayInstanceStruct *chartInstance);
...
static const mxArray *c30_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static real_T c30_emlrt_marshallIn(SFc30_ArrayInstanceStruct *chartInstance,
  const mxArray *c30_I, const char_T *c30_identifier);
static real_T c30_b_emlrt_marshallIn(SFc30_ArrayInstanceStruct *chartInstance,
...
static const mxArray *c30_b_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static int32_T c30_c_emlrt_marshallIn(SFc30_ArrayInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void c30_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData);
static uint8_T c30_d_emlrt_marshallIn(SFc30_ArrayInstanceStruct *chartInstance,
  const mxArray *c30_b_is_active_c30_Array, const char_T *c30_identifier);
static uint8_T c30_e_emlrt_marshallIn(SFc30_ArrayInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void init_dsm_address_info(SFc30_ArrayInstanceStruct *chartInstance);
...
static void initialize_c30_Array(SFc30_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c30_is_active_c30_Array = 0U;
}
  ...
  *chartInstance)
{
  ...
  c30_b_hoistedGlobal = chartInstance->c30_is_active_c30_Array;
  ...
  const mxArray *c30_st)
{
  ...
  *c30_I = c30_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c30_u,
    0)), "I");
  chartInstance->c30_is_active_c30_Array = c30_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c30_u, 1)), "is_active_c30_Array");
  sf_mex_destroy(&c30_u);
  c30_update_debugger_state_c30_Array(chartInstance);
...
static void sf_c30_Array(SFc30_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c30_sfEvent = CALL_EVENT;
  c30_chartstep_c30_Array(chartInstance);
  ...
  *c30_inData)
{
  ...
  real_T c30_u;
  const mxArray *c30_y = NULL;
  SFc30_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc30_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c30_Array_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c30_b_is_active_c30_Array, const char_T *c30_identifier)
{
  ...
  c30_y = c30_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c30_b_is_active_c30_Array), &c30_thisId);
  sf_mex_destroy(&c30_b_is_active_c30_Array);
  return c30_y;
}
...
/* SFunction Glue Code */
void sf_c30_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c30_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c30_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c30_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c30_Array_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc30_ArrayInstanceStruct *chartInstance;
    chartInstance = (SFc30_ArrayInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c30_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc30_ArrayInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c30_Array(void *chartInstanceVar)
{
  enable_c30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c30_Array(void *chartInstanceVar)
{
  disable_c30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c30_Array(void *chartInstanceVar)
{
  sf_c30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c30_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c30_Array((SFc30_ArrayInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c30_Array();/* state var info */
...
extern void sf_internal_set_sim_state_c30_Array(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c30_Array((SFc30_ArrayInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c30_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c30_Array(S);
}

static void sf_opaque_set_sim_state_c30_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c30_Array(S, st);
}

static void sf_opaque_terminate_c30_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc30_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc30_Array((SFc30_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c30_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c30_Array((SFc30_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c30_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c30_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c30_Array(SimStruct *S)
{
  SFc30_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc30_ArrayInstanceStruct *)malloc(sizeof
    (SFc30_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc30_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c30_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c30_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c30_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c30_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c30_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c30_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c30_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c30_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c30_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c30_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c30_Array;
...
void c30_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c30_Array(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c30_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c30_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c30_Array_method_dispatcher.\n"
