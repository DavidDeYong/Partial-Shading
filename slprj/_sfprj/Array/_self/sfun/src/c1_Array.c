...
static void initialize_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void initialize_params_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void enable_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void disable_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Array(SFc1_ArrayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_Array(SFc1_ArrayInstanceStruct
  *chartInstance);
static void set_sim_state_c1_Array(SFc1_ArrayInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void sf_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void c1_chartstep_c1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void initSimStructsc1_Array(SFc1_ArrayInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_ArrayInstanceStruct *chartInstance, const
  mxArray *c1_I, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_ArrayInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_ArrayInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_ArrayInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_Array, const char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ArrayInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_ArrayInstanceStruct *chartInstance);
...
static void initialize_c1_Array(SFc1_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Array = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_Array;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_I = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "I");
  chartInstance->c1_is_active_c1_Array = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_Array");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Array(chartInstance);
...
static void sf_c1_Array(SFc1_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Array(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u;
  const mxArray *c1_y = NULL;
  SFc1_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc1_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Array_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_Array, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_Array),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Array);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c1_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Array_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_ArrayInstanceStruct *chartInstance;
    chartInstance = (SFc1_ArrayInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ArrayInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Array(void *chartInstanceVar)
{
  enable_c1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Array(void *chartInstanceVar)
{
  disable_c1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Array(void *chartInstanceVar)
{
  sf_c1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Array((SFc1_ArrayInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Array();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Array(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_Array((SFc1_ArrayInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Array(S);
}

static void sf_opaque_set_sim_state_c1_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_Array(S, st);
}

static void sf_opaque_terminate_c1_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Array((SFc1_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_Array((SFc1_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Array(SimStruct *S)
{
  SFc1_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc1_ArrayInstanceStruct *)malloc(sizeof
    (SFc1_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_Array;
...
void c1_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Array_method_dispatcher.\n"
