...
static void initialize_c9_Array(SFc9_ArrayInstanceStruct *chartInstance);
static void initialize_params_c9_Array(SFc9_ArrayInstanceStruct *chartInstance);
static void enable_c9_Array(SFc9_ArrayInstanceStruct *chartInstance);
static void disable_c9_Array(SFc9_ArrayInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_Array(SFc9_ArrayInstanceStruct
  *chartInstance);
...
static void set_sim_state_c9_Array(SFc9_ArrayInstanceStruct *chartInstance,
  const mxArray *c9_st);
static void finalize_c9_Array(SFc9_ArrayInstanceStruct *chartInstance);
...
static void initSimStructsc9_Array(SFc9_ArrayInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_ArrayInstanceStruct *chartInstance, const
  mxArray *c9_I, const char_T *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_ArrayInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_ArrayInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static uint8_T c9_e_emlrt_marshallIn(SFc9_ArrayInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_ArrayInstanceStruct *chartInstance);
...
static void initialize_c9_Array(SFc9_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_Array = 0U;
}
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  chartInstance = (SFc9_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_Array_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c9_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c9_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_Array_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c9_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_ArrayInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c9_Array(void *chartInstanceVar)
{
  enable_c9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_Array(void *chartInstanceVar)
{
  disable_c9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c9_Array(void *chartInstanceVar)
{
  sf_c9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_Array((SFc9_ArrayInstanceStruct*)
...
static const mxArray* sf_opaque_get_sim_state_c9_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_Array(S);
}

static void sf_opaque_set_sim_state_c9_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c9_Array(S, st);
}

static void sf_opaque_terminate_c9_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc9_Array((SFc9_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_Array((SFc9_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c9_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c9_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_Array(SimStruct *S)
{
  SFc9_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc9_ArrayInstanceStruct *)malloc(sizeof
    (SFc9_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c9_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c9_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c9_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c9_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c9_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c9_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_Array;
...
void c9_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_Array_method_dispatcher.\n"
