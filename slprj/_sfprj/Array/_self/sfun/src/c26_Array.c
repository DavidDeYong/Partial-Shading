...
static void initialize_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void initialize_params_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void enable_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void disable_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void c26_update_debugger_state_c26_Array(SFc26_ArrayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c26_Array(SFc26_ArrayInstanceStruct
  *chartInstance);
static void set_sim_state_c26_Array(SFc26_ArrayInstanceStruct *chartInstance,
  const mxArray *c26_st);
static void finalize_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void sf_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void c26_chartstep_c26_Array(SFc26_ArrayInstanceStruct *chartInstance);
static void initSimStructsc26_Array(SFc26_ArrayInstanceStruct *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static real_T c26_emlrt_marshallIn(SFc26_ArrayInstanceStruct *chartInstance,
  const mxArray *c26_I, const char_T *c26_identifier);
static real_T c26_b_emlrt_marshallIn(SFc26_ArrayInstanceStruct *chartInstance,
...
static const mxArray *c26_b_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static int32_T c26_c_emlrt_marshallIn(SFc26_ArrayInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void c26_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static uint8_T c26_d_emlrt_marshallIn(SFc26_ArrayInstanceStruct *chartInstance,
  const mxArray *c26_b_is_active_c26_Array, const char_T *c26_identifier);
static uint8_T c26_e_emlrt_marshallIn(SFc26_ArrayInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_ArrayInstanceStruct *chartInstance);
...
static void initialize_c26_Array(SFc26_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_Array = 0U;
}
  ...
  *chartInstance)
{
  ...
  c26_b_hoistedGlobal = chartInstance->c26_is_active_c26_Array;
  ...
  const mxArray *c26_st)
{
  ...
  *c26_I = c26_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c26_u,
    0)), "I");
  chartInstance->c26_is_active_c26_Array = c26_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c26_u, 1)), "is_active_c26_Array");
  sf_mex_destroy(&c26_u);
  c26_update_debugger_state_c26_Array(chartInstance);
...
static void sf_c26_Array(SFc26_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_sfEvent = CALL_EVENT;
  c26_chartstep_c26_Array(chartInstance);
  ...
  *c26_inData)
{
  ...
  real_T c26_u;
  const mxArray *c26_y = NULL;
  SFc26_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc26_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c26_Array_get_eml_resolved_functions_info(void)
{
  ...
  (*c26_b_info)[0].fileTimeLo = 1289530492U;
  ...
  (*c26_b_info)[1].fileTimeLo = 1325134938U;
  (*c26_b_info)[1].fileTimeHi = 0U;
  (*c26_b_info)[1].mFileTimeLo = 1319744366U;
  ...
  const mxArray *c26_b_is_active_c26_Array, const char_T *c26_identifier)
{
  ...
  c26_y = c26_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_Array), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_Array);
  return c26_y;
}
...
/* SFunction Glue Code */
void sf_c26_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c26_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c26_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c26_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_Array_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc26_ArrayInstanceStruct *chartInstance;
    chartInstance = (SFc26_ArrayInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c26_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_ArrayInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c26_Array(void *chartInstanceVar)
{
  enable_c26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c26_Array(void *chartInstanceVar)
{
  disable_c26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c26_Array(void *chartInstanceVar)
{
  sf_c26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c26_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c26_Array((SFc26_ArrayInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c26_Array();/* state var info */
...
extern void sf_internal_set_sim_state_c26_Array(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c26_Array((SFc26_ArrayInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c26_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c26_Array(S);
}

static void sf_opaque_set_sim_state_c26_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c26_Array(S, st);
}

static void sf_opaque_terminate_c26_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc26_Array((SFc26_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c26_Array((SFc26_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c26_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c26_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_Array(SimStruct *S)
{
  SFc26_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc26_ArrayInstanceStruct *)malloc(sizeof
    (SFc26_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c26_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c26_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c26_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c26_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c26_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c26_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c26_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c26_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c26_Array;
...
void c26_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_Array(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_Array_method_dispatcher.\n"
