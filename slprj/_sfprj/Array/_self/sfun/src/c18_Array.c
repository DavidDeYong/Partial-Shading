...
static void initialize_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void initialize_params_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void enable_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void disable_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_Array(SFc18_ArrayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c18_Array(SFc18_ArrayInstanceStruct
  *chartInstance);
static void set_sim_state_c18_Array(SFc18_ArrayInstanceStruct *chartInstance,
  const mxArray *c18_st);
static void finalize_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void sf_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void c18_chartstep_c18_Array(SFc18_ArrayInstanceStruct *chartInstance);
static void initSimStructsc18_Array(SFc18_ArrayInstanceStruct *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_ArrayInstanceStruct *chartInstance,
  const mxArray *c18_I, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_ArrayInstanceStruct *chartInstance,
...
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_ArrayInstanceStruct *chartInstance,
  const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_ArrayInstanceStruct *chartInstance,
  const mxArray *c18_b_is_active_c18_Array, const char_T *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_ArrayInstanceStruct *chartInstance,
  const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_ArrayInstanceStruct *chartInstance);
...
static void initialize_c18_Array(SFc18_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_Array = 0U;
}
  ...
  *chartInstance)
{
  ...
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_Array;
  ...
  const mxArray *c18_st)
{
  ...
  *c18_I = c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c18_u,
    0)), "I");
  chartInstance->c18_is_active_c18_Array = c18_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c18_u, 1)), "is_active_c18_Array");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_Array(chartInstance);
...
static void sf_c18_Array(SFc18_ArrayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_sfEvent = CALL_EVENT;
  c18_chartstep_c18_Array(chartInstance);
  ...
  *c18_inData)
{
  ...
  real_T c18_u;
  const mxArray *c18_y = NULL;
  SFc18_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc18_ArrayInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_Array_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c18_b_is_active_c18_Array, const char_T *c18_identifier)
{
  ...
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_Array), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_Array);
  return c18_y;
}
...
/* SFunction Glue Code */
void sf_c18_Array_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_Array_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c18_Array(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"I\",},{M[8],M[0],T\"is_active_c18_Array\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_Array_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_ArrayInstanceStruct *chartInstance;
    chartInstance = (SFc18_ArrayInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c18_Array(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_ArrayInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
  initialize_c18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c18_Array(void *chartInstanceVar)
{
  enable_c18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c18_Array(void *chartInstanceVar)
{
  disable_c18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c18_Array(void *chartInstanceVar)
{
  sf_c18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_Array(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_Array((SFc18_ArrayInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_Array();/* state var info */
...
extern void sf_internal_set_sim_state_c18_Array(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c18_Array((SFc18_ArrayInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_Array(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_Array(S);
}

static void sf_opaque_set_sim_state_c18_Array(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c18_Array(S, st);
}

static void sf_opaque_terminate_c18_Array(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_ArrayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc18_Array((SFc18_ArrayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_Array(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c18_Array((SFc18_ArrayInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c18_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c18_Array(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_Array(SimStruct *S)
{
  SFc18_ArrayInstanceStruct *chartInstance;
  chartInstance = (SFc18_ArrayInstanceStruct *)malloc(sizeof
    (SFc18_ArrayInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_ArrayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c18_Array;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c18_Array;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c18_Array;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_Array;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_Array;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c18_Array;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c18_Array;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c18_Array;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_Array;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_Array;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c18_Array;
...
void c18_Array_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_Array(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_Array(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_Array(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_Array_method_dispatcher.\n"
